...
[_BL] = KEYMAP_HHKB(
  ...
  KC_LALT,MO(_FL),KC_LGUI,                KC_SPC,                                 KC_RGUI,MO(_FL),KC_RCTL,KC_RALT),
...
[_FL] = KEYMAP_HHKB(
  ...
  _______,_______,_______,_______,_______,_______,_______,_______, KC_INS,_______,KC_PSCR, BL_DEC,BL_INC,  KC_DEL, \
  ...
  #else
  _______,  KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9, KC_F10, KC_F11, KC_F12,_______,RESET, \
  _______,_______,_______,_______,_______,_______,_______,KC_PGUP, KC_INS,_______,KC_PSCR,_______,_______, KC_DEL, \
  _______,_______,_______,KC_PGDN,_______,_______,KC_LEFT,KC_DOWN,  KC_UP,KC_RGHT,_______,_______,        _______,  \
  _______,        KC_MUTE,KC_VOLD,KC_VOLU,_______,_______,_______,_______,KC_HOME, KC_END,_______,        _______,_______, \
  _______,_______,_______,                _______,                                _______,_______,_______,_______),
  #endif
};
