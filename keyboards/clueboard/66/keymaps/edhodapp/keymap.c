...
[_BL] = LAYOUT(
  ...
  KC_LALT,MO(_FL),KC_LGUI,_______,        KC_SPC, KC_SPC,                         _______,KC_RGUI,MO(_FL),MO(_CL),KC_LEFT,KC_DOWN,KC_RGHT),
...
[_FL] = LAYOUT(
  ...
  _______,MO(_FL),_______,_______,        _______,_______,                        _______,_______,MO(_FL),_______,KC_HOME,KC_PGDN,KC_END),
